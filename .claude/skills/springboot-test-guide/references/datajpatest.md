...
void shouldFindOrdersByStatus() {
  ...
  // Then - Using sequenced collection methods (Java 21+)
...
6. Leverage Java 10+ var keyword for cleaner variable declarations
7. Use sequenced collection methods (getFirst(), getLast(), reversed()) with Java 21+
